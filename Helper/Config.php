...
{
    public const XPATH_REGISTER_URL_LIVE   = 'adcurve/settings/url_register_live';
    public const XPATH_REGISTER_URL_TEST   = 'adcurve/settings/url_register_test';
    public const XPATH_TAG_URL_LIVE        = 'adcurve/settings/url_tag_live';
    public const XPATH_TAG_URL_TEST        = 'adcurve/settings/url_tag_test';
    public const XPATH_API_UPDATE_URL_LIVE = 'adcurve/api/update_url_live';
    public const XPATH_API_UPDATE_URL_TEST = 'adcurve/api/update_url_test';
    public const XPATH_API_STATUS_URL_LIVE = 'adcurve/api/status_url_live';
    public const XPATH_API_STATUS_URL_TEST = 'adcurve/api/status_url_test';
    public const XPATH_API_ROLE_CREATED_FAILED_URL = 'adcurve/api/role_created_failed';
    public const XPATH_PAYMENT_METHOD      = 'payment/checkmo/active';
     ...
     * @return \Adcurve\Adcurve\Model\Connection
     */
    public function getAdcurveConnectionByStore($storeId = 0)
    {
        if ($storeId > 0) {
            // @TODO: Look into a more secure method for try catch to avoid crash at all time
            try {
