<?php
namespace Adcurve\Adcurve\Block\System\Config\Form;
	...
	implements \Magento\Framework\Data\Form\Element\Renderer\RendererInterface
{
	...
	protected $_template = 'Adcurve_Adcurve::system/config/form/registrationform.phtml';
	...
	{
		var_dump(get_class($this->authSession->getUser()));
