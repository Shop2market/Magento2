...
class StatusRequest extends AbstractRequest
{
    ...
    public const STATUS_ERROR_UNKNOWN = '2';
    public const STATUS_ERROR_CONNECTION_TO_ADCURVE = '3';
    public const STATUS_ERROR_RESULT_FROM_ADCURVE = '4';
    ...
    public function getConnectionStatus($connection)
    {
        ...
        switch ($result['status']) {
            ...
            case self::STATUS_ERROR_RESULT_FROM_ADCURVE:
                ...
                $this->_getConnectionModel()->setSuggestion(
                    __(
                        'Connection with Adcurve API not established yet. Please follow this %1 for more information',
            ...
            case self::STATUS_SUCCESS:
                ...
                $this->_getConnectionModel()->setSuggestion(
                    __('Connection to Adcurve successfully established and Registration complete.')
                );
                break;
        }
